...
export default function HomePage() {
  return (
    <main className="font-sans text-gray-800 bg-white">
      ...
      {/* INTRO VIDEO */}
      <section className="max-w-6xl mx-auto my-20 px-6" id="intro-video">
        <h2 className="text-4xl font-bold text-center mb-10 text-gray-900">Our Journey</h2>
      ...
      <section className="bg-gray-50 py-20 px-6" id="seal">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4 text-gray-900">Starbrands Seal of Excellence</h2>
      ...
      <section className="py-20 px-6" id="awards">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4 text-gray-900">Annual Excellence Awards</h2>
          <p className="mb-12 text-lg text-gray-600">
      ...
      <section className="bg-gray-50 py-20 px-6" id="investor">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4 text-gray-900">Investor Hub</h2>
          <p className="mb-12 text-lg text-gray-600">
      ...
      <section className="py-20 px-6 bg-gray-100" id="contact">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-4 text-gray-900">Let’s Build Excellence Together</h2>
          <p className="mb-12 text-lg text-gray-600">
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 px-6 mt-20">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex gap-6 flex-wrap justify-center">
            <a href="#seal" className="hover:text-white transition-colors">Seal Application</a>
            <a href="#awards" className="hover:text-white transition-colors">Awards Nomination</a>
            <a href="#investor" className="hover:text-white transition-colors">Investor Portal</a>
          </div>
          <div className="text-sm text-center md:text-right">
            &copy; 2025 Starbrands East Africa | <a href="#" className="hover:text-white transition-colors">Privacy Policy</a> | <a href="#" className="hover:text-white transition-colors">Terms of Service</a>
          </div>
        </div>
      </footer>
    </main>
